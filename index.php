    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <div class="w3-light-grey w3-round-xlarge w3-small">
              <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skills[$i]['persent']; ?>%"><?php echo $skills[$i]['persent']; ?></div>
            </div>
            <?php
            	endfor;
            ?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          ?>
          <?php
            if($work[$i]['end'] == 'Current'):
          ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $work[$i]['title']; ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work[$i]['start']; ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $work[$i]['end']; ?></span></h6>
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $work[$i]['title']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work[$i]['start']; ?> - <?php echo $work[$i]['end']; ?></h6>
            <p><?php echo $work[$i]['description']; ?></p>
            <hr>
          </div>
          <?php
